      ...
      >
        <Toolbar>
          ...
          >
            ...
            />
            &nbsp;
            <h3 className={classes.pageHeading}>SMART INVEST Using Blockchain</h3>
          </Typography>
        </Toolbar>
      </AppBar>
      <Drawer
      ...
      >
        ...
        <List>
          <Link to="/" style={{ textDecoration: "none", color: "#fff" }}>
            <ListItem>
              <ListItemText> 
                <h3 className={classes.pageHeading}>HOME</h3></ListItemText>
            </ListItem>
          </Link>
          ...
          >
            <ListItem>
              <ListItemText>
              <h3 className={classes.pageHeading}>EXPLORER</h3>
            </ListItemText>
            </ListItem>
          </Link>
